...
static void InitColors(void)
{
    ...
    DefineColor("Dark Green", 0, 0.5, 0.1);
    DefineColor("Tiffany Green", 0.7, 0.94, 0.78);
    DefineColor("Soft Yellow", 0.96, 0.85, 0.57);
    DefineColor("Soft Orange", 255/255, 162/255, 56/255);
    DefineColor("Light Brown", 163/255, 105/255, 11/255);
    DefineColor("Middle Brown", 209/255, 191/255, 135/255);
}
